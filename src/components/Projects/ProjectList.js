const ProjectsList = {
    ...
    Splitter : {
        "title" : "Splitter",
        "content": "Splitter is a very simple to use app, created to split bills between you and your friends in a party, reunion or even trip. (this is a work in the early stages of development, currently you can visualize it only in it's mobil version)",
